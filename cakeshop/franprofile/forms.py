...
class Franchisepro(forms.Form):
    ...
    price1=forms.IntegerField(label="Price of 1kg",required=False, widget=forms.TextInput(attrs={'placeholder':'Enter Price of 1 kg','class':'form-control'}))
    price2=forms.IntegerField(label="Price of 2kgs ",required=False, widget=forms.TextInput(attrs={'placeholder':'Enter Price of 2kgs','class':'form-control'}))
    price3=forms.IntegerField(label="Price of 3kgs",required=False, widget=forms.TextInput(attrs={'placeholder':'Enter Price of 3kgs','class':'form-control'}))
